...
public class EntityAuditListener {
    ...
    public void onUserCreate(User user) {
        try {
            ...
            // AuditService will extract actor context from Spring Security
            auditService.logActionWithValues("User", user.getId(), AuditAction.USER_REGISTERED, null, newValues);
    ...
    public void onUserUpdate(User user) {
        try {
            ...
            auditService.logActionWithValues("User", user.getId(), AuditAction.PROFILE_UPDATED, null, newValues);
    ...
    public void onOrganizationCreate(Organization org) {
        try {
            ...
            auditService.logActionWithValues("Organization", org.getId(), AuditAction.BANK_REGISTERED, null, newValues);
    ...
    public void onOrganizationUpdate(Organization org) {
        try {
            ...
            auditService.logActionWithValues("Organization", org.getId(), AuditAction.BANK_ACTIVATED, null, newValues);
