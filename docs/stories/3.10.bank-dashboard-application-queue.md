...
- [ ] Task 1: Create Application Queue Request/Response DTOs (AC: 1, 2)
  - [ ] Create ApplicationQueueItem (src/main/java/com/creditapp/bank/dto/ApplicationQueueItem.java)
  ...
  - [ ] Create ApplicationQueueResponse (src/main/java/com/creditapp/bank/dto/ApplicationQueueResponse.java)
...
- [ ] Task 2: Create Application Queue Service (AC: 1, 2, 3, 4)
  - [ ] Create ApplicationQueueService (src/main/java/com/creditapp/bank/service/ApplicationQueueService.java)
...
- [ ] Task 3: Create Application Queue Controller (AC: 1, 7)
  - [ ] Create BankApplicationQueueController (src/main/java/com/creditapp/bank/controller/BankApplicationQueueController.java)
  ...
  - [ ] Error handling: 403 Forbidden if officer doesn't belong to bank, 404 Not Found

- [ ] Task 4: Implement Real-Time Updates (AC: 5)
  - [ ] Option A: WebSocket endpoint for real-time updates
  ...
  - [ ] Alternative: Client-side polling (less ideal but simpler)
    - JavaScript polling every 30 seconds
    - Document in frontend integration notes

- [ ] Task 5: Create Application Queue Repository (AC: 1, 4)
  - [ ] Create custom queries in ApplicationRepository
...
- [ ] Task 6: Create Application Status Transition Validator (AC: 6, 7)
  - [ ] Create ApplicationStatusValidator (src/main/java/com/creditapp/shared/validator/ApplicationStatusValidator.java)
  ...
  - [ ] Unit test: verify transitions

- [ ] Task 7: Create Application Status Update Service (AC: 7, 9)
  - [ ] Create ApplicationStatusUpdateService (src/main/java/com/creditapp/bank/service/ApplicationStatusUpdateService.java)
...
- [ ] Task 8: Create Queue Metrics Calculation (AC: 2)
  - [ ] Create ApplicationQueueMetrics class (src/main/java/com/creditapp/shared/model/ApplicationQueueMetrics.java)
...
- [ ] Task 9: Create Unit Tests (AC: 1, 2, 3, 4)
  - [ ] Create ApplicationQueueServiceTest (src/test/java/com/creditapp/unit/bank/ApplicationQueueServiceTest.java)
...
- [ ] Task 10: Create Controller Tests (AC: 1, 7)
  - [ ] Create BankApplicationQueueControllerTest (src/test/java/com/creditapp/unit/bank/BankApplicationQueueControllerTest.java)
...
- [ ] Task 11: Create Integration Tests (AC: 1, 2, 3, 4, 10)
  - [ ] Create ApplicationQueueIntegrationTest (src/test/java/com/creditapp/integration/bank/ApplicationQueueIntegrationTest.java)
...
- [ ] Task 12: Create WebSocket Tests (AC: 5)
  - [ ] Create ApplicationQueueWebSocketTest
...
- [ ] Task 13: Create API Documentation (AC: 1, 7)
...
- [ ] Task 14: Add Logging and Monitoring (AC: 8, 9)
...
- [ ] Task 15: Create Notification Service Integration (AC: 7, 9)
...
### Testing Checklist
- [ ] Queue retrieval: returns applications with selected offers
- [ ] Only selected offers: no applications without selected offers
- [ ] Sorting by date: newest first
- [ ] Sorting by APR: correct order
- [ ] Sorting by loan amount: correct order
- [ ] Filter by status: correct subset
- [ ] Filter by APR range: correct range
- [ ] Filter by loan amount: correct range
- [ ] Filter by date range: correct range
- [ ] Pagination: correct limit and offset
- [ ] Queue metrics: accurate counts
- [ ] Status update: valid transitions allowed
- [ ] Invalid status: invalid transitions rejected
- [ ] Audit logging: status changes logged
- [ ] Email notification: borrower notified
- [ ] Bank-specific: only own applications visible
- [ ] WebSocket updates: real-time notifications sent
- [ ] Response time: <200ms for queue retrieval
- [ ] API documentation: endpoints documented
- [ ] Error handling: 400, 403, 404, 500 errors
- [ ] Integration test: end-to-end queue and status update
