...
- [ ] Task 1: Create Withdraw Request/Response DTOs (AC: 4, 7)
  - [ ] Create WithdrawApplicationRequest DTO
    - Fields: withdrawalReason (optional String, max 500 chars)
    - Validations: @Size(max=500)
  - [ ] Create WithdrawApplicationResponse DTO
...
- [ ] Task 2: Create Application Withdrawal Service (AC: 2, 3, 4, 5)
  - [ ] Create WithdrawApplicationService or extend ApplicationService
  ...
  - [ ] Unit tests: mock repositories, test state validation, test audit logging

- [ ] Task 3: Create Withdrawal Email Service (AC: 6)
  - [ ] Create ApplicationWithdrawalEmailService (src/main/java/com/creditapp/shared/service/ApplicationWithdrawalEmailService.java)
...
- [ ] Task 4: Create Withdraw Application REST Endpoint (AC: 1, 7, 8)
...
- [ ] Task 5: Add Exception Handlers (AC: 3)
  - [ ] Create custom exception: ApplicationNotWithdrawableException (extends RuntimeException)
...
- [ ] Task 6: Add Database Migration (AC: 5)
  - [ ] Create V12__Add_Withdrawal_Fields_To_Application.sql migration
...
- [ ] Task 7: Update Application Entity (AC: 5)
  - [ ] Update Application entity to add:
    - withdrawnAt (LocalDateTime nullable)
    - withdrawalReason (String nullable)

- [ ] Task 8: Create Unit Tests (AC: 2, 4, 5)
  - [ ] Create ApplicationWithdrawalUnitTest
  ...
  - [ ] Mock: ApplicationRepository, ApplicationStatusTransitionService, ApplicationWithdrawalEmailService

- [ ] Task 9: Create Access Control Tests (AC: 8)
  - [ ] Create ApplicationWithdrawalAccessControlTest
...
- [ ] Task 10: Create Integration Tests (AC: 1, 5, 6, 9)
  - [ ] Create ApplicationWithdrawalIntegrationTest
...
- [ ] Task 11: Create API Documentation (AC: 1)
  - [ ] Document POST /api/borrower/applications/{applicationId}/withdraw
...
## Testing Checklist
- [ ] Withdraw from DRAFT, SUBMITTED, UNDER_REVIEW, OFFERS_AVAILABLE states
- [ ] Cannot withdraw from terminal states (409)
- [ ] Withdrawn_at timestamp set
- [ ] Withdrawal reason stored (optional)
- [ ] ApplicationHistory entry created
- [ ] Audit logging: APPLICATION_WITHDRAWN event
