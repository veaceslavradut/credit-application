...
- [ ] Task 1: Create Database Migrations for Offer Tables (AC: 1, 2, 3, 4, 5, 6)
  - [ ] Create V14__Create_Bank_Rate_Card_Table.sql migration
  ...
  - [ ] Create V15__Create_Offers_Table.sql migration
  ...
  - [ ] Create V16__Create_Offer_Calculation_Log_Table.sql migration
...
- [ ] Task 2: Create BankRateCard JPA Entity (AC: 2, 5, 7)
...
- [ ] Task 3: Create Offer JPA Entity (AC: 1, 5, 6, 7)
...
- [ ] Task 4: Create OfferCalculationLog JPA Entity (AC: 3, 7)
  ...
  - [ ] Create CalculationType enum: MOCK_CALCULATION, REAL_API, OVERRIDE
  - [ ] Unit tests: verify entity creation, JSON storage

- [ ] Task 5: Create Repositories (AC: 4)
...
- [ ] Task 7: Create Service Layer (AC: 1, 5)
...
- [ ] Task 8: Add Audit Trail Integration (AC: 3)
  - [ ] Ensure OfferCalculationLog entries created for all calculations
  - [ ] Log OFFER_CALCULATED audit event via AuditService (Story 1.7)
  - [ ] Audit events: OFFER_CALCULATED, OFFER_SUBMITTED, OFFER_ACCEPTED, OFFER_EXPIRED
...
- [ ] Task 10: Create API Documentation (AC: 1, 2, 3)
  - [ ] Update docs/API_ENDPOINTS.md with offer data model overview
    - Document Offer entity fields and relationships
    - Document BankRateCard entity fields and versioning strategy
