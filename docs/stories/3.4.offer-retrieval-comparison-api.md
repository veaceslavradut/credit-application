...
- [ ] Task 1: Create Offer Comparison Schema (AC: 2, 4)
  - [ ] Define 8 core comparison fields (standardized across all banks):
  ...
  - [ ] Create OfferComparisonDTO (src/main/java/com/creditapp/borrower/dto/OfferComparisonDTO.java)
...
- [ ] Task 2: Create Offer Retrieval Service (AC: 1, 3, 5, 6)
  - [ ] Create OfferRetrievalService (src/main/java/com/creditapp/borrower/service/OfferRetrievalService.java)
  ...
  - [ ] Unit tests: mock repositories, test sorting, test access control

- [ ] Task 3: Create REST Controller Endpoint (AC: 1, 7, 8, 9)
  - [ ] Create or update BorrowerOfferController (src/main/java/com/creditapp/borrower/controller/BorrowerOfferController.java)
  ...
  - [ ] Integration tests: real HTTP requests, verify sorting, verify disclaimer

- [ ] Task 4: Add Disclaimer & Metadata (AC: 8)
  - [ ] Create OfferComparisonResponse (src/main/java/com/creditapp/borrower/dto/OfferComparisonResponse.java)
    - Fields: 
      - disclaimer: String
      - offers: List<OfferComparisonDTO>
      - applicationId: UUID
...
- [ ] Task 5: Implement Caching for Performance (AC: 9)
  - [ ] Add @Cacheable to OfferRetrievalService.getOffersForApplication()
    - Cache key: applicationId:borrowerId
    - Cache name: "offers"
    - TTL: 5 minutes (offers don't change unless new calculation triggered)
  - [ ] Add cache eviction on offer creation (Story 3.3)
    - When OfferCalculationService creates offers, call cache.evict(applicationId)
  - [ ] Optional: Use Redis for distributed caching if using load-balanced servers

- [ ] Task 6: Create Bank Logo URL Mapping (AC: 2)
  - [ ] Add logoUrl field to Organization entity (Story 1.2 update)
    - Store URL to bank logo image
    - Used in offer response for UI display
  - [ ] Or create static mapping of bank IDs to logo URLs
  - [ ] Default logo if not available

- [ ] Task 7: Add Query Optimization (AC: 9)
  - [ ] Optimize OfferRepository.findByApplicationId() query
  ...
  - [ ] Example: 
    ...
    `
  - [ ] Unit tests: verify query count <2

- [ ] Task 8: Create Unit Tests (AC: 3, 5, 7)
  - [ ] Create OfferRetrievalServiceTest (src/test/java/com/creditapp/unit/borrower/OfferRetrievalServiceTest.java)
  ...
  - [ ] Mock: OfferRepository, ApplicationRepository, OrganizationRepository
  - [ ] Framework: JUnit 5, Mockito

- [ ] Task 9: Create Integration Tests (AC: 1, 10)
  - [ ] Create OfferRetrievalIntegrationTest (src/test/java/com/creditapp/integration/borrower/OfferRetrievalIntegrationTest.java)
  ...
  - [ ] Use: TestContainers (PostgreSQL), TestRestTemplate, real HTTP requests
  - [ ] Database: Real data with multiple offers
...
- [ ] Task 11: Add Logging (AC: 1)
  - [ ] Log offer retrieval requests
...
- [ ] Task 12: Create Frontend Integration Notes (AC: 4)
